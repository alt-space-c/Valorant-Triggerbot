...
## Usage
1. First run Unique.py to make the triggerbot file unique and avoid possibly getting banned. (Very low chance as I have not been banned in 4 months of using this)
